...
var $author$project$Main$decoderOfEvidence = A5(
...
var $author$project$Main$decoderOfScenario = A6(
	...
	$author$project$Main$Scenario,
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'rules',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'gmToken', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'players',
		$elm$json$Json$Decode$list($author$project$Main$decoderOfPlayer)),
	A2(
		$elm$json$Json$Decode$field,
		'evidences',
		$elm$json$Json$Decode$list($author$project$Main$decoderOfEvidence)));
...
var $author$project$Main$init = function (value) {
	return _Utils_Tuple2(
		A4(
			...
			'',
			$elm$core$Dict$empty,
			A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decoderOfScenario, value)),
...
var $author$project$Main$GM = {$: 0};
var $author$project$Main$InvalidToken = {$: 3};
var $author$project$Main$PL = function (a) {
	return {$: 1, a: a};
};
	...
	function (scenario, token) {
		if (_Utils_eq(scenario.Z, token)) {
			...
			if (!_v0.$) {
				...
				return $author$project$Main$InvalidToken;
			}
		}
	});
...
var $author$project$Main$errorBody = function (msg) {
	return _List_fromArray(
		[
...
var $author$project$Main$InputEvidenceToken = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
...
var $author$project$Main$htmlOfEvidences = function (dict) {
	return A2(
		...
		$elm$core$List$map(
			function (evi) {
				return A2(
					$author$project$Main$htmlOfEvidence,
					A2(
						$elm$core$Maybe$withDefault,
						false,
						A2(
...
var $author$project$Main$gmBody = function (scenario) {
	return _Utils_ap(
		...
		_Utils_ap(
			A2(
				$author$project$Main$htmlOfEvidences,
